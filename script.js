...
function newText(){
    let textArr = [
        ...
        "Perhaps you may enjoy a shorter text.",
        "Perhaps you may enjoy trying this more.",
        "These text are randomly generated!",
        "Good luck and try your best!"
    ];
    originText = document.querySelector("#origin-text p").innerHTML = textArr[Math.floor(Math.random() * 13)];
    reset();
}
// Event listeners for keyboard input and the reset
changeTextButton.addEventListener("click", newText, false);
